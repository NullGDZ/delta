...
class GUI {
	...
	updateRows() {
		if (this.rowsinit) {
			...
			document.getElementById("massbots_mode_key").innerText = this.getmassbots();
			...
			this.divs.rows.massbots.innerHTML = `<span>Mass: <span id="massbots_mode_key">${this.getmassbots()}</span></span> ${this.socket.GUI.inputs.massbots.outerHTML}`;
			...
			// Botón de inicio/detención con estilo mejorado
			...
			startStopButton.style.fontSize = "11px";
