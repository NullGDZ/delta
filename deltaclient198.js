...
class GUI {
    ...
    initialize() {
        ...
        try {
            ...
            titleDiv.setAttribute("style", "color: #00aaff;font-weight: bold;text-align: center;font-size: 15px;margin-bottom: 2px;border-bottom: 1px solid #555;padding-bottom: 4px;");
