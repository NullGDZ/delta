...
class GUI {
    ...
    initialize() {
        ...
        try {
            ...
            this.divs.maindiv.setAttribute("style", "width: 180px;position: fixed;z-index: 999;left: 15px;top: 50%;transform: translateY(-50%);background: rgba(0, 0, 0, 0.6);border: 1px solid #333;padding: 8px;border-radius: 10px;box-shadow: 0 0 10px rgba(0,0,0,0.5);"), 
    ...
    // Nueva función para iniciar/detener bots
    toggleBots() {
