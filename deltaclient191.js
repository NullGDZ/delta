...
class GUI {
	...
	initialize() {
		...
		try {
			...
			this.divs.maindiv.setAttribute("style", "width: 160px;position: fixed;z-index: 999;left: 3px;top: 1px;background: rgba(0, 0, 0, 0.7);border: 1px solid #444;padding: 8px;border-radius: 8px;box-shadow: 0 0 10px rgba(0,0,0,0.5);");
