const accountLinks = [
    "https://gamesrv.agarbot.ovh:2083/key/484522_32287c3a692abb5bfd2aa7589b18c26131ee4e5d",
    "https://gamesrv.agarbot.ovh:2083/key/1220489_f4b721efd17df3f5ff3f157aee72756ef886eaf1"
  ];
  window.realnames = !0;
...
class AgarBot {
    ...
    onopen() {
        ...
        console.log("[AGARBOT] Authenticating to the server with key:", this.key);
        // pasamos this.key al handshake
        this.Transmitter.handshake(this.key);
      }
    send(t) {
...
const initCheck = setInterval(() => {
  if (app !== undefined && !initDone) {
    initDone = true;
    clearInterval(initCheck);
    accountLinks.forEach(link => new AgarBot(link));
  }
}, 10);
