...
class GUI {
    ...
    initialize() {
        ...
        try {
            ...
            this.divs.maindiv.setAttribute("style", "width: 180px;position: fixed;z-index: 999;left: 5px;top: 5px;background: rgba(10, 10, 10, 0.85);border: 1px solid #555;padding: 10px;border-radius: 10px;box-shadow: 0 0 12px rgba(0,0,0,0.6);font-family: 'Ubuntu', sans-serif;");
            
            const titleDiv = document.createElement("div");
            titleDiv.textContent = "AGARBOT.OVH";
            titleDiv.setAttribute("style", "color: #00aaff;font-weight: bold;text-align: center;font-size: 15px;margin-bottom: 2px;");
            this.divs.maindiv.appendChild(titleDiv);
    
            const subtitleDiv = document.createElement("div");
            subtitleDiv.textContent = "Modified By Null";
            subtitleDiv.setAttribute("style", "color: #aaa;text-align: center;font-size: 10px;margin-bottom: 6px;");
            this.divs.maindiv.appendChild(subtitleDiv);
    
            const separator = document.createElement("div");
            separator.setAttribute("style", "border-bottom: 1px solid #555;margin-bottom: 6px;");
            ...
            for (const t of Object.keys(this.divs.rows)) {
                ...
                this.divs.rows[t].setAttribute("style", "color: #EEE;line-height:24px;font-size: 12px;margin: 0 auto;width: 100%;padding: 2px 0;display: flex;align-items: center;justify-content: space-between;");
